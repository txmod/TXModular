	...
	*new{ arg argInstName;
	...
	init {arg argInstName;
		...
		arrSynthArgSpecs = [
			...
			["op6FreqRatio", 1.001, defLagTime],
			["op6Phase", 0, defLagTime],
			["op6Amp", 0.5, defLagTime],
			["modFM_11", 0, defLagTime],
			["modFM_12", 0.5, defLagTime],
			["modFM_13", 0.25, defLagTime],
		...
		arrOptionData = [
			...
			// amp env
			TXEnvLookup.arrSlopeOptionData,  // 7
			TXEnvLookup.arrDADSRSustainOptionData,  // 8
			// op env 1
			TXEnvLookup.arrSlopeOptionData,  // 9
			TXEnvLookup.arrDADSRSustainOptionData,  // 10
			[  // 11
				["Off", { 0; }],
			...
			// op env 2
			TXEnvLookup.arrSlopeOptionData,  // 12
			TXEnvLookup.arrDADSRSustainOptionData,  // 13
			[  // 14
				["Off", { 0; }],
				["On", {arg envFunction, del, att, dec, sus, sustime, rel, envCurve, gate;
					EnvGen.ar(
		...
		synthDefFunc = {
			...
			modEnvAmountOp1=0, modDelayOp1=0, modAttackOp1=0, modDecayOp1=0, modSustainOp1=0,
			modSustainTimeOp1=0, modReleaseOp1=0,
			modEnvAmountOp2=0, modDelayOp2=0, modAttackOp2=0, modDecayOp2=0, modSustainOp2=0,
			modSustainTimeOp2=0, modReleaseOp2=0,

			mmOp1FreqRatio=0, mmOp1Phase=0, mmOp1Amp=0,
			mmOp2FreqRatio=0, mmOp2Phase=0, mmOp2Amp=0,
			mmOp3FreqRatio=0, mmOp3Phase=0, mmOp3Amp=0,
			mmOp4FreqRatio=0, mmOp4Phase=0, mmOp4Amp=0,
			mmOp5FreqRatio=0, mmOp5Phase=0, mmOp5Amp=0,
			mmOp6FreqRatio=0, mmOp6Phase=0, mmOp6Amp=0,
			mmModFM_11=0, mmModFM_12=0, mmModFM_13=0, mmModFM_14=0, mmModFM_15=0, mmModFM_16=0,
			mmModFM_21=0, mmModFM_22=0, mmModFM_23=0, mmModFM_24=0, mmModFM_25=0, mmModFM_26=0,
			mmModFM_31=0, mmModFM_32=0, mmModFM_33=0, mmModFM_34=0, mmModFM_35=0, mmModFM_36=0,
			mmModFM_41=0, mmModFM_42=0, mmModFM_43=0, mmModFM_44=0, mmModFM_45=0, mmModFM_46=0,
			mmModFM_51=0, mmModFM_52=0, mmModFM_53=0, mmModFM_54=0, mmModFM_55=0, mmModFM_56=0,
			mmModFM_61=0, mmModFM_62=0, mmModFM_63=0, mmModFM_64=0, mmModFM_65=0, mmModFM_66=0;
			...
			if (displayEnv == "showOp2", {
				guiSpecArray = guiSpecArray ++[
					...
					["TXMinMaxSliderSplit", "Release", classData.timeSpec, "releaseOp2", "releaseMinOp2", "releaseMaxOp2",
						{{this.updateOpEnvView(2);}.defer;}],
					["NextLine"],
					["SynthOptionPopup", "Curve", arrOptionData, 12, 180, {system.showView;}],
			...
			if (displayEnv == "showVolEnv", {
				guiSpecArray = guiSpecArray ++[
					...
					["TXMinMaxSliderSplit", "Release", classData.timeSpec, "release", "releaseMin", "releaseMax",
						{{this.updateEnvView;}.defer;}],
					["NextLine"],
					["SynthOptionPopup", "Curve", arrOptionData, 7, 180, {system.showView;}],
