	...
	*new{ arg argInstName;
	...
	init {arg argInstName;
		...
		synthDefFunc = {
			...
			modFreqLFO1 = 0, modFadeInLFO1 = 0, modFreqLFO2 = 0, modFadeInLFO2 = 0, modSlider1 = 0, modSlider2 = 0;
	...
	buildGuiSpecArray {
		...
		if (displayOption == "showWaveform", {
			guiSpecArray = guiSpecArray ++[
				["SynthOptionListPlusMinus", "Waveform", arrOptionData, 0, nil, 140, {system.flagGuiUpd}],
		...
		if (displayOption == "showEnv", {
			guiSpecArray = guiSpecArray ++[
				...
				["TXMinMaxSliderSplit", "Release", timeSpec, "release", "releaseMin", "releaseMax",{{this.updateEnvView;}.defer;}],
				["NextLine"],
				["SynthOptionPopup", "Curve", arrOptionData, 2, 180, {system.showView;}],
		...
		if (displayOption == "showLFO", {
			guiSpecArray = guiSpecArray ++[
				...
				["TXMinMaxSliderSplit", "Frequency", ControlSpec(0.001, 100, \exp, 0, 1, units: " Hz"),
					"freqLFO1", "freqLFO1Min", "freqLFO1Max", nil, TXLFO.arrLFOFreqRanges],
		...
		if (displayOption == "showModMatrix", {
			guiSpecArray = guiSpecArray ++[
				...
				["ModMatrixRowScale", arrMMSourceNames, arrMMDestNames,
					"i_Source0", "i_Dest0", "mmValue0", arrMMScaleNames, "i_Scale0"],
				["ModMatrixRowScale", arrMMSourceNames, arrMMDestNames,
					"i_Source1", "i_Dest1", "mmValue1", arrMMScaleNames, "i_Scale1"],
				["ModMatrixRowScale", arrMMSourceNames, arrMMDestNames,
					"i_Source2", "i_Dest2", "mmValue2", arrMMScaleNames, "i_Scale2"],
				["ModMatrixRowScale", arrMMSourceNames, arrMMDestNames,
					"i_Source3", "i_Dest3", "mmValue3", arrMMScaleNames, "i_Scale3"],
				["ModMatrixRowScale", arrMMSourceNames, arrMMDestNames,
					"i_Source4", "i_Dest4", "mmValue4", arrMMScaleNames, "i_Scale4"],
				["ModMatrixRowScale", arrMMSourceNames, arrMMDestNames,
					"i_Source5", "i_Dest5", "mmValue5", arrMMScaleNames, "i_Scale5"],
				["ModMatrixRowScale", arrMMSourceNames, arrMMDestNames,
					"i_Source6", "i_Dest6", "mmValue6", arrMMScaleNames, "i_Scale6"],
				["ModMatrixRowScale", arrMMSourceNames, arrMMDestNames,
					"i_Source7", "i_Dest7", "mmValue7", arrMMScaleNames, "i_Scale7"],
				["ModMatrixRowScale", arrMMSourceNames, arrMMDestNames,
					"i_Source8", "i_Dest8", "mmValue8", arrMMScaleNames, "i_Scale8"],
				["ModMatrixRowScale", arrMMSourceNames, arrMMDestNames,
					"i_Source9", "i_Dest9", "mmValue9", arrMMScaleNames, "i_Scale9"],
			];
		});
	}
