...
TXMatrixAudio8x8 : TXModuleBase {
	...
	*initClass{
		...
		classData.defaultName = "Matrix A 8x8";
	...
	*new{ arg argInstName;
	...
	init {arg argInstName;
		...
		synthDefFunc = { arg input1, input2, input3, input4, input5, input6, input7, input8,
			...
			modIn1Out1=0, modIn1Out2=0, modIn1Out3=0, modIn1Out4=0, modIn1Out5=0, modIn1Out6=0, modIn1Out7=0, modIn1Out8=0, modIn2Out1=0, modIn2Out2=0, modIn2Out3=0, modIn2Out4=0, modIn2Out5=0, modIn2Out6=0, modIn2Out7=0, modIn2Out8=0, modIn3Out1=0, modIn3Out2=0, modIn3Out3=0, modIn3Out4=0, modIn3Out5=0, modIn3Out6=0, modIn3Out7=0, modIn3Out8=0, modIn4Out1=0, modIn4Out2=0, modIn4Out3=0, modIn4Out4=0, modIn4Out5=0, modIn4Out6=0, modIn4Out7=0, modIn4Out8=0, modIn5Out1=0, modIn5Out2=0, modIn5Out3=0, modIn5Out4=0, modIn5Out5=0, modIn5Out6=0, modIn5Out7=0, modIn5Out8=0, modIn6Out1=0, modIn6Out2=0, modIn6Out3=0, modIn6Out4=0, modIn6Out5=0, modIn6Out6=0, modIn6Out7=0, modIn6Out8=0, modIn7Out1=0, modIn7Out2=0, modIn7Out3=0, modIn7Out4=0, modIn7Out5=0, modIn7Out6=0, modIn7Out7=0, modIn7Out8=0, modIn8Out1=0, modIn8Out2=0, modIn8Out3=0, modIn8Out4=0, modIn8Out5=0, modIn8Out6=0, modIn8Out7=0, modIn8Out8=0,
			modOutLevel=0;

			var arrInOuts, arrModInOuts, arrSums;
			...
			holdInput1 = InFeedback.ar(input1, 1);
			holdInput2 = InFeedback.ar(input2, 1);
			holdInput3 = InFeedback.ar(input3, 1);
			holdInput4 = InFeedback.ar(input4, 1);
			holdInput5 = InFeedback.ar(input5, 1);
			holdInput6 = InFeedback.ar(input6, 1);
			holdInput7 = InFeedback.ar(input7, 1);
			holdInput8 = InFeedback.ar(input8, 1);

			holdOutLevel = 0.5 * (outLevel + modOutLevel).max(0).min(1);
			Out.ar(out, startEnv * holdOutLevel *
				arrSums.clump(8).flop.collect({ arg item, i;
					var arrLevels = item.squared;
					var reduceScale = (1 - autoLevelReduction) + (autoLevelReduction * arrLevels.sum.max(1).reciprocal);
					reduceScale * Mix.new(
						[holdInput1, holdInput2, holdInput3, holdInput4,
		...
		guiSpecArray = [
			...
			["NextLine"],
			["EZslider", "Output Level", ControlSpec(0, 1), "outLevel", nil, 320],
			["TXCheckBox", "Auto scale (output reduced if mixed level headroom exceeds 1)",
				"autoLevelReduction", nil, 380],
		];
