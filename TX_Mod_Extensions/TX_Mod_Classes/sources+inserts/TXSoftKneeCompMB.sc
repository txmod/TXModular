...
TXSoftKneeCompMB : TXModuleBase {		// MultiBand Compressor module
	...
	*initClass{
		...
		classData.defaultName = "SoftKnee CompMB";
	...
	*new{ arg argInstName;
	...
	init {arg argInstName;
		...
		compressFunc = {arg bandIndex, input, sideChainSig, kneeMax, ratioMin, ratioMax, attackMax, releaseMax,
			...
			var inputDelayed, thresholdSum, ratioSum, kneeSum, attackSum, releaseSum;
			...
			controlSignal = this.getSynthOption(bandIndex).value(input, sideChainSig);
		...
		synthDefFunc = { arg in, sideChain, out, splitFreq1, splitFreq2, splitFreq3,
			...
			if (this.getSynthOption(6) == 1, {
				band1 = compressFunc.value(0, split[0], sideChain1, kneeMax, ratioMin, ratioMax, attackMax, releaseMax,
					threshold1, knee1, ratio1, attack1, release1,
					makeUpGain1, wetDryMix1, modThreshold1, modKnee1, modRatio1, modAttack1, modRelease1, modWetDryMix1);
			}, {
				// input delayed
			...
			if (this.getSynthOption(7) == 1, {
				band2 = compressFunc.value(1, split[1], sideChain2, kneeMax, ratioMin, ratioMax, attackMax, releaseMax,
					threshold2, knee2, ratio2, attack2, release2,
					makeUpGain2, wetDryMix2, modThreshold2, modKnee2, modRatio2, modAttack2, modRelease2, modWetDryMix2);
			}, {
			...
			if (this.getSynthOption(8) == 1, {
				band3 = compressFunc.value(2, split[2], sideChain3, kneeMax, ratioMin, ratioMax, attackMax, releaseMax,
					threshold3, knee3, ratio3, attack3, release3,
					makeUpGain3, wetDryMix3, modThreshold3, modKnee3, modRatio3, modAttack3, modRelease3, modWetDryMix3);
			}, {
			...
			if (this.getSynthOption(9) == 1, {
				band4 = compressFunc.value(3, split[3], sideChain4, kneeMax, ratioMin, ratioMax, attackMax, releaseMax,
					threshold4, knee4, ratio4, attack4, release4,
					makeUpGain4, wetDryMix4, modThreshold4, modKnee4, modRatio4, modAttack4, modRelease4, modWetDryMix4);
			}, {
