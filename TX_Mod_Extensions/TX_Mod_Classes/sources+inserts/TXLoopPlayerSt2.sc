	...
	*new{ arg argInstName;
	...
	init {arg argInstName;
		...
		synthDefFunc = {
			...
			envtime=0, modStart=0, modEnd=0, modReverse=0, windowRandomness;
			...
			outLoop = outFunction.value(bufnumLoopStereo, bufnumLoopMono, outIndex, 1, windowSize,
				overlaps, windowRandomness, interpolation) * level.squared * 2;
		...
		arrActionSpecs = this.buildActionSpecs([
			...
			["SynthOptionPopupPlusMinus", "Loop type", arrOptionData, 0, 210],
	...
	buildGuiSpecArray {
		guiSpecArray = [
			...
			["ActionButton", "Play test loop",
				...
				90, TXColor.white, TXColor.sysGuiCol2],
			["Spacer", 3],
			["ActionButton", "Stop test loop", {this.allNotesOff;},
				90, TXColor.white, TXColor.sysDeleteCol],
			["SpacerLine", 4],
		];
