...
TXDualFilterSt : TXModuleBase {
	...
	*initClass{
		...
		classData.defaultName = "Dual Filter St";
	...
	*new{ arg argInstName;
	...
	init {arg argInstName;
		...
		arrActionSpecs = this.buildActionSpecs([
			...
			["SynthOptionCheckBox", "Use Ratio B instead of Freq B", arrOptionData, 6, 264],
			["SynthOptionCheckBox", "Use Resonance A for Resonance B", arrOptionData, 7, 264],
			["SynthOptionCheckBox", "Use Saturation A for Saturation B", arrOptionData, 8, 264],
			["SynthOptionCheckBox", "Use Gain A for Gain B", arrOptionData, 5, 264],
