	...
	*new{ arg argInstName;
	...
	init {arg argInstName;
		...
		synthDefFunc = {
			...
			envtime2, delayEnv2, attackEnv2, attackMinEnv2, attackMaxEnv2, decayEnv2, decayMinEnv2, decayMaxEnv2,
		...
		arrActionSpecs = this.buildActionSpecs([
			...
			["TXMinMaxSliderSplit", "Env 2 Decay", timeSpec, "decayEnv2", "decayMinEnv2", "decayMaxEnv2",{{this.updateEnvView2;}.defer;}],
			...
			["SynthOptionPopup", "Env 2 Env Type", arrOptionData, 5, 300],
	...
	buildGuiSpecArray {
		...
		if (displayOption == "showEnv2", {
			guiSpecArray = guiSpecArray ++[
				...
				["SpacerLine", 2],
				["TXMinMaxSliderSplit", "Attack", timeSpec, "attackEnv2", "attackMinEnv2", "attackMaxEnv2",{{this.updateEnvView2;}.defer;}],
				["SpacerLine", 2],
				...
				["TXMinMaxSliderSplit", "Sustain time", timeSpec, "sustainTimeEnv2", "sustainTimeMinEnv2",
					"sustainTimeMaxEnv2",{{this.updateEnvView2;}.defer;}],
				["SpacerLine", 2],
				["TXMinMaxSliderSplit", "Release", timeSpec, "releaseEnv2", "releaseMinEnv2", "releaseMaxEnv2",{{this.updateEnvView2;}.defer;}],
				["SpacerLine", 2],
