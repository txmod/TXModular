...
TXSoftKneeComp : TXModuleBase {
	...
	*initClass{
		...
		classData.defaultName = "SoftKnee Comp";
	...
	init {arg argInstName;
		...
		arrOptionData = [
			...
			[ // 1 - compression type
				...
				["RMS Compression - averaging time: 50 ms", {
					arg in, control, thresh, ratio, knee, attack, release, makeUp;
					SoftKneeCompressor.rms(in, control, thresh, ratio, knee, attack, release, makeUp,
		...
		synthDefFunc = { arg in, sideChain, out, threshold, knee, kneeMin, kneeMax,
			...
			var input, inputDelayed, thresholdSum, makeUpSum, compRatioSum, kneeSum, attackSum, releaseSum;
		...
		guiSpecArray = [
			...
			["DividingLine"],
			["SpacerLine", 6],
			["EZslider", "Make-up gain", ControlSpec(0, 1), "makeUp"],
			["SpacerLine", 2],
			["WetDryMixSlider"],
		];
