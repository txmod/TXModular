...
TXMixAudio8to1 : TXModuleBase {
	...
	*initClass{
		...
		classData.defaultName = "Mix Audio 8-1";
	...
	*new{ arg argInstName;
	...
	init {arg argInstName;
		...
		synthDefFunc = { arg input1, input2, input3, input4, input5, input6, input7, input8,
			...
			modLevel1=0, modLevel2=0, modLevel3=0, modLevel4=0, modLevel5=0, modLevel6=0, modLevel7=0, modLevel8=0,
			modOutLevel=0;
			...
			holdInput1 = InFeedback.ar(input1, 1) * holdLevel1;
			holdInput2 = InFeedback.ar(input2, 1) * holdLevel2;
			holdInput3 = InFeedback.ar(input3, 1) * holdLevel3;
			holdInput4 = InFeedback.ar(input4, 1) * holdLevel4;
			holdInput5 = InFeedback.ar(input5, 1) * holdLevel5;
			holdInput6 = InFeedback.ar(input6, 1) * holdLevel6;
			holdInput7 = InFeedback.ar(input7, 1) * holdLevel7;
			holdInput8 = InFeedback.ar(input8, 1) * holdLevel8;
