	...
	*new{ arg argInstName;
	...
	init {arg argInstName;
		...
		guiSpecArray = [
			...
			["TextViewDisplay", "Coding Notes: Enter Supercollider 3 code in the window below. The code needs to be a function which returns a stereo audio signal. The function will be passed the arguments Modify 1, Modify 2, Modify 3, Modify 4.  Use the Evaulate text button to store and evaluate the code.", 400, 70, "Notes"],
