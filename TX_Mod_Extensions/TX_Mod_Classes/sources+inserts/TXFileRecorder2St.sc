...
TXFileRecorder2St : TXModuleBase {		// File Recorder module - stereo version
	...
	*initClass{
		...
		classData.defaultName = "File Recorder St";
		...
		classData.arrBufferSpecs = [ ["bufnumOutBuffer", 65536, 2] ];
	}
	...
	*stopAllRecorders {
	...
	init {arg argInstName;
		...
		synthDefFunc = {
			...
			recordFormat, recordTime, leftLevel, rightLevel, outLevel, modLeftLvl=0, modRightLvl=0;
