...
TXOSCControlOut : TXModuleBase {
	...
	*initClass{
		...
		classData.defaultName = "OSC Control Out";
	...
	*addressesCopyAll { arg argData;
	...
	init {arg argInstName;
		...
		synthDefFunc = { arg out, on, controlValue, controlValMin, controlValMax, modControlVal=0;
