...
TXSamplePlayerPlus3St : TXModuleBase {
	...
	*initClass{
		...
		classData.arrCtlSCInBusSpecs = [
			...
			["Env 2 Delay", 1, "modDelayEnv2", 0],
			["Env 2 Attack", 1, "modAttackEnv2", 0],
			["Env 2 Decay", 1, "modDecayEnv2", 0],
			["Env 2 Sustain level", 1, "modSustainEnv2", 0],
			["Env 2 Sustain level 2", 1, "modSustain2Env2", 0],
			["Env 2 Sustain time", 1, "modSustainTimeEnv2", 0],
			["Env 2 Release", 1, "modReleaseEnv2", 0],
	...
	*new{ arg argInstName;
	...
	init {arg argInstName;
		...
		synthDefFunc = {
			...
			envtime2=0, delayEnv2, attackEnv2, attackMinEnv2, attackMaxEnv2, decayEnv2, decayMinEnv2, decayMaxEnv2,
			...
			modDelayEnv2 = 0, modAttackEnv2 = 0, modDecayEnv2 = 0, modSustainEnv2 = 0, modSustain2Env2 = 0,
			...
			sStart, sEnd, rev, del, att, dec, sus, sus2, sustime, rel,
			env2del, env2att, env2dec, env2sus, env2sus2, env2sustime, env2rel,
			...
			outEnv2 = envGenFunction2.value(envFunction2, env2del, env2att, env2dec, env2sus, env2sus2, env2sustime,
				env2rel, envCurve2, gate);
			...
			outSample = outFunction.value(outRate, bufnumSampleStereo, bufnumSampleMono, sStart, sEnd) * sumLevel;
		...
		arrActionSpecs = this.buildActionSpecs([
			...
			["EZslider", "Env 2 Pre-Delay", ControlSpec(0,1), "delayEnv2", {{this.updateEnvView2;}.defer;}],
			["TXMinMaxSliderSplit", "Env 2 Attack", timeSpec, "attackEnv2", "attackMinEnv2", "attackMaxEnv2",
				{{this.updateEnvView2;}.defer;}],
			["TXMinMaxSliderSplit", "Env 2 Decay", timeSpec, "decayEnv2", "decayMinEnv2", "decayMaxEnv2",
				{{this.updateEnvView2;}.defer;}],
			["EZslider", "Env 2 Sustain level", ControlSpec(0, 1), "sustainEnv2", {{this.updateEnvView2;}.defer;}],
			["EZslider", "Env 2 Sustain level 2", ControlSpec(0, 1), "sustain2Env2", {{this.updateEnvView2;}.defer;}],
			["TXMinMaxSliderSplit", "Env 2 Sustain time", timeSpec, "sustainTimeEnv2", "sustainTimeMinEnv2",
				"sustainTimeMaxEnv2",{{this.updateEnvView2;}.defer;}],
			["TXMinMaxSliderSplit", "Env 2 Release", timeSpec, "releaseEnv2", "releaseMinEnv2", "releaseMaxEnv2",
				{{this.updateEnvView2;}.defer;}],
			["SynthOptionPopup", "Env 2 Curve", arrOptionData, 4, 240, {system.showView;}],
			["SynthOptionPopup", "Env 2 Type", arrOptionData, 5, 180],
	...
	buildGuiSpecArray {
		...
		if (displayOption == "showEnv2", {
			guiSpecArray = guiSpecArray ++[
				["SynthOptionCheckBox", "Envelope 2", arrOptionData, 14, 250],
				["TXPresetPopup", "Env presets",
					TXEnvPresets.arrEnvPresetsEnv2(this, 4, 5).collect({arg item, i; item.at(0)}),
					TXEnvPresets.arrEnvPresetsEnv2(this, 4, 5).collect({arg item, i; item.at(1)}),
					340
				],
				["TXEnvPlot", {this.envViewValues2;}, {arg view; envView2 = view;}],
				["NextLine"],
				["SpacerLine", 2],
				["EZslider", "Pre-Delay", ControlSpec(0,1), "delayEnv2", {{this.updateEnvView2;}.defer;}],
				["SpacerLine", 2],
				["TXMinMaxSliderSplit", "Attack", timeSpec, "attackEnv2", "attackMinEnv2", "attackMaxEnv2",
					{{this.updateEnvView2;}.defer;}],
				["SpacerLine", 2],
				["TXMinMaxSliderSplit", "Decay", timeSpec, "decayEnv2", "decayMinEnv2", "decayMaxEnv2",{{this.updateEnvView2;}.defer;}],
				["SpacerLine", 2],
				["EZslider", "Sustain level", ControlSpec(0, 1), "sustainEnv2", {{this.updateEnvView2;}.defer;}],
				["SpacerLine", 2],
				["EZslider", "Sustain level 2", ControlSpec(0, 1), "sustain2Env2", {{this.updateEnvView2;}.defer;}],
				["SpacerLine", 2],
				["TXMinMaxSliderSplit", "Sustain time", timeSpec, "sustainTimeEnv2", "sustainTimeMinEnv2",
					"sustainTimeMaxEnv2",{{this.updateEnvView2;}.defer;}],
				["SpacerLine", 2],
				["TXMinMaxSliderSplit", "Release", timeSpec, "releaseEnv2", "releaseMinEnv2", "releaseMaxEnv2",
					{{this.updateEnvView2;}.defer;}],
				["SpacerLine", 2],
