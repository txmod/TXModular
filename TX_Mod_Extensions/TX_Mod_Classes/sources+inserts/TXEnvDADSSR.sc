...
TXEnvDADSSR : TXModuleBase {
	...
	*initClass{
		...
		classData.defaultName = "Env DADSSR";
	...
	*new{ arg argInstName;
	...
	init {arg argInstName;
		...
		synthDefFunc = {
			...
			sustain, sustain2, sustainTime, sustainTimeMin, sustainTimeMax, release, releaseMin, releaseMax,
			velocityScaling,
			modDelay = 0, modAttack = 0, modDecay = 0, modSustain = 0, modSustain2 = 0,
